...
<form action="../updateRescue/update_ReportReviewing.php" method="POST" style="display:inline;">
...
<form action="../updateRescue/update_ReportDeclined.php" method="POST" style="display:inline;">
    <input type="hidden" name="petid" value="<?= htmlspecialchars($petid) ?>">
    <input type="hidden" name="currentStatus" value="<?= htmlspecialchars($petDetails['reportStatus'] ?? 'N/A') ?>">
