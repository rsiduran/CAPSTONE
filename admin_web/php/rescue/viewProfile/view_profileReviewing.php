...
<div class="sidebar">
    ...
    <div class="collapse" id="applicationMenu">
      ...
      <a href="../../../php/application/applicationCompleted.php" class="sub-link">Completed <span class="badge bg-danger"><?= $adoptionCounts['PENDING'] ?? 0 ?></span></a>
      <a href="../../../php/application/applicationRejected.php" class="sub-link">Rejected <span class="badge bg-danger"><?= $adoptionCounts['PENDING'] ?? 0 ?></span></a>
    </div>
  ...
  <div class="d-flex">
  <form action="../updateRescue/update_ReportReviewing.php" method="POST" class="me-2">
  ...
  <form action="../updateRescue/update_ReportDeclined.php" method="POST">
    <input type="hidden" name="petid" value="<?= htmlspecialchars($petid) ?>">
    <input type="hidden" name="currentStatus" value="<?= htmlspecialchars($petDetails['reportStatus'] ?? 'N/A') ?>">
    <button type="submit" class="ms-2 btn btn-danger btn-sm">DECLINED</button>
  </form>
</div>
