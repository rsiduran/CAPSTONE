...
//         // Delete from missing
//         $firebase->deleteDocument("rescue", $petid);

//         // Redirect after deletion
//         header("Location: rescueDeclined.php");
//         exit();
//     }
// }

$pendingPets = array_filter($pets, function($pet) {
    return isset($pet['reportStatus']) && $pet['reportStatus'] === 'DECLINED';
});
?>
...
<body>
  ...
  <div div class="main-content">
    <div class="container-fluid mt-5 pt-3">
      <h1>Declined Status Reports</h1>
      <p>Below is the list of Declined Status Reports currently registered in the system:</p>
          ...
          <?php if (!empty($pendingPets)) : ?>
            <?php foreach ($pendingPets as $petid => $pet) : ?>
              <tr>
                ...
                <td>
                <a href="viewProfile/view_profileDeclined.php?petid=<?= urlencode($petid) ?>" class="btn btn-primary btn-sm">View Profile</a>
                <!-- <a href="rescueDeclined.php?petid=<?= urlencode($petid) ?>" class="btn btn-danger btn-sm">Delete</a> -->
                </td>
            </tr>
            <?php endforeach; ?>
          <?php else : ?>
            <tr>
              <td colspan="5" class="text-center">No Declined Status applications found</td>
            </tr>
          <?php endif; ?>
          </tbody>
        </table>
