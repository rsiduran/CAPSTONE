  ...
  <div div class="main-content">
    <div class="container-fluid mt-5 pt-3">
      ...
      <div class="input-group" style="width: 50%; margin: 0 auto;">
          ...
          <a href="rescueDeclined.php" class="btn btn-secondary">Reset</a>
      </div>
    </form>
        ...
        <tr>
            ...
            <td><?= htmlspecialchars($pet['reportStatus'] ?? 'N/A') ?></td>
              ...
              ?>
                ...
                <td>
                    <a href="viewProfile/markAsViewedDeclined.php?petid=<?= urlencode($petid) ?>&collection=rescue" class="btn btn-primary btn-sm">View Profile</a>
                </td>
            </tr>
            <?php endforeach; ?>
          <?php else : ?>
