...
$pendingPets = array_filter($pets, function($pet) {
    return isset($pet['reportStatus']) && $pet['reportStatus'] === 'RESCUED';
});
?>
...
<div class="sidebar">
  ...
  <div class="main-content">
    <div class="container-fluid mt-5 pt-3">
      <h1>Rescued Status Reports</h1>
      <p>Below is the list of Rescued Status Reports currently registered in the system:</p>
        ...
        <tr>
            ...
            <td><?= htmlspecialchars($pet['reportStatus'] ?? 'N/A') ?></td>
              ...
              ?>
                ...
                <td>
                    <a href="viewProfile/markAsViewedRescued.php?petid=<?= urlencode($petid) ?>&collection=rescue" class="btn btn-primary btn-sm">View Profile</a>
                </td>
            </tr>
            <?php endforeach; ?>
          <?php else : ?>
            <tr>
              <td colspan="5" class="text-center">No Rescued Status applications found</td>
            </tr>
          <?php endif; ?>
          </tbody>
        </table>
