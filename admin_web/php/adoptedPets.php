...
$pets = $firebase->getDocuments("adopted");
...
<body>
  ...
  <div class="main-content">
    <div class="container-fluid mt-5 pt-3">
      <h1>Adopted Pets </h1>
      <p>Below is the list of pets adopted which currently registered in the system:</p>
          ...
          <?php if (!empty($pets)) : ?>
            <?php foreach ($pets as $petid => $pet) : ?>
              <tr>
                ...
                <td>
                    <a href="viewProfile/view_profileAdopted.php?petid=<?= urlencode($petid) ?>" class="btn btn-primary btn-sm">View Profile</a>
                </td>
            </tr>
            <?php endforeach; ?>
          <?php else : ?>
