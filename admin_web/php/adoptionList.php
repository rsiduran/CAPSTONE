...
if ($searchQuery) {
    $pets = array_filter($pets, function ($pet) use ($searchQuery) {
        ...
        return (
            ...
            (isset($pet['age']) && stripos($pet['age'], $searchQuery) !== false) ||
            (isset($pet['size']) && stripos($pet['size'], $searchQuery) !== false) ||
  ...
  <div class="main-content">
    ...
    <form method="GET" class="mb-4">
      <div class="input-group" style="width: 50%; margin: 0 auto;">
          ...
          <a href="adoptionList.php" class="btn btn-secondary">Reset</a>
      </div>
    </form>
        ...
        <table class="table table-hover mx-auto" style="width: 90%;">
          <thead class="table-success">
            <tr>
              ...
              <th>Age
              <a href="?sortField=age&sortOrder=asc" class="sort-dropdown">↑</a>
              <a href="?sortField=age&sortOrder=desc" class="sort-dropdown">↓</a>
              </th>
              <th>Size
              <a href="?sortField=size&sortOrder=asc" class="sort-dropdown">↑</a>
              <a href="?sortField=size&sortOrder=desc" class="sort-dropdown">↓</a>
              </th>
              <th>Timestamp
          ...
          <?php if (!empty($pets)) : ?>
            <?php foreach ($pets as $petid => $pet) : ?>
              ...
              ?>
                ...
                <td>
                <a href="viewProfile/markAsViewedAdoption.php?petid=<?= urlencode($petid) ?>&collection=adoption" class="btn btn-primary btn-sm">View Profile</a>
                </td>
            </tr>
            <?php endforeach; ?>
          <?php else : ?>
