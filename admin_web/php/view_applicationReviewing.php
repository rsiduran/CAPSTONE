...
<div class="back-button-container">
    <a href="applicationPending.php" class="back-button">Back</a>
</div>

<div class="container">
  <h1>Pet Application Form</h1>
  
  <form action="update_applicationReviewing.php" method="POST">
  <input type="hidden" name="petid" value="<?= htmlspecialchars($petid) ?>">
    ...
    <br>
    <form action="update_applicationRejected.php" method="POST">
  <input type="hidden" name="petid" value="<?= htmlspecialchars($petid) ?>">
        <input type="hidden" name="currentStatus" value="<?= htmlspecialchars($petDetails['applicationStatus'] ?? 'N/A') ?>">
