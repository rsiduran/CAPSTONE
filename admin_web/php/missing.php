...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="collapse" id="adoptionMenu">
      <a href="adoptionList" class="sub-link">Pet Adoption List</a>
          ...
          <?php if (!empty($pets)) : ?>
            <?php foreach ($pets as $petid => $pet) : ?>
              <tr>
                ...
                <td>
                  <a href="viewProfile/view_profileMissing.php?petid=<?= urlencode($petid) ?>" class="btn btn-primary btn-sm">View Profile</a>
