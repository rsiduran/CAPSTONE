...
if (isset($_GET['petid'])) {
    ...
    if (!$petDetails) {
      echo "Pet not found in 'missing' collection.";
      exit();
  }  
...
<body>
  ...
  <div class="main-content">
    <div class="container-fluid mt-5 pt-3">
      <h1>Missing Pets</h1>
      <p>Below is the list of missing pets currently registered in the system:</p>
    ...
    <form method="GET" class="mb-4">
      <div class="input-group" style="width: 50%; margin: 0 auto;">
          ...
          <a href="missing.php" class="btn btn-secondary">Reset</a>
      </div>
    </form>
          ...
          <?php if (!empty($pets)) : ?>
            <?php foreach ($pets as $petid => $pet) : ?>
              ...
              ?>
                ...
                <td>
                <a href="viewProfile/markAsViewedMissing.php?petid=<?= urlencode($petid) ?>&collection=missing" class="btn btn-primary btn-sm">View Profile</a>
                <a href="missing.php?petid=<?= urlencode($petid) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this pet?');">Delete</a>
                </td>
              </tr>
            <?php endforeach; ?>
          <?php else : ?>
