...
$pendingPets = array_filter($pets, function($pet) {
    return isset($pet['applicationStatus']) && $pet['applicationStatus'] === 'REVIEWING';
});
?>
...
<body>
  ...
  <div class="main-content">
    <div class="container-fluid mt-5 pt-3">
      <h1>Reviewing Adoption Application</h1>
      <p>Below is the list of Reviewing Adoption Application currently registered in the system:</p>
      ...
      <div class="input-group" style="width: 50%; margin: 0 auto;">
          ...
          <a href="applicationReviewing.php" class="btn btn-secondary">Reset</a>
      </div>
    </form>
        ...
        <tr>
            ...
            <td><?= htmlspecialchars($pet['applicationStatus'] ?? 'N/A') ?></td>
              ...
              ?>
                ...
                <td>
                    <a href="viewApplication/markAsViewedAppReviewing.php?petid=<?= urlencode($petid) ?>&collection=adoptionApplication" class="btn btn-primary btn-sm">View Application Form</a>
                </td>
              </tr>
            <?php endforeach; ?>
          <?php else : ?>
            <tr>
              <td colspan="5" class="text-center">No reviewing applications found</td>  
          </tr>
          <?php endif; ?>
          </tbody>
        </table>
