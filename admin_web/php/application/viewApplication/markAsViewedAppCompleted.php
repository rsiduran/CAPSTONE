...
if (isset($_GET['petid']) && isset($_GET['collection'])) {
    ...
    $updateData = [
        ...
        'adoptionDate' => new DateTime($currentDocument['fields']['adoptionDate']['timestampValue'] ?? 'now'),
    ...
    $fieldsToKeep = [
        ...
        'petId', 'salaryRange', 'statusChange', 'remarks', 'adoptionDate', 'personnel'
    ];
    ...
    header("Location: view_applicationCompleted.php?petid=" . urlencode($petid));
    exit();
}
?>
