...
<div class="back-button-container">
    <a href="../applicationReviewing.php" class="back-button">Back</a>
</div>

<div class="container">
  <h1>Pet Application Form</h1>
  
  <form action="../updateApplication/update_applicationReviewing.php" method="POST">
  <input type="hidden" name="petid" value="<?= htmlspecialchars($petid) ?>">
        ...
        <button type="submit" class="btn btn-warning btn-sm">ACCEPTED</button>
    </form>
    <br>
    <form action="../updateApplication/update_applicationRejected.php" method="POST">
  <input type="hidden" name="petid" value="<?= htmlspecialchars($petid) ?>">
        <input type="hidden" name="currentStatus" value="<?= htmlspecialchars($petDetails['applicationStatus'] ?? 'N/A') ?>">
        <button type="submit" class="btn btn-warning btn-sm">REJECTED</button>
    </form></p>
    <div class="row mb-4">
      <div class="col-md-6">
