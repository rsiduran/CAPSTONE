...
$usersCount = $firebase->getCollectionCount('users');
  ...
  <div class="main-content">
    <div class="container mt-4 p-5">
      ...
      <form action="../updateApplication/update_applicationReviewing.php" method="POST" style="display:inline;">
    ...
    <button type="submit" class="btn btn-success btn-sm mb-4">APPROVED</button>
</form>

<form action="../updateApplication/update_applicationRejected.php" method="POST" style="display:inline;">
    <input type="hidden" name="petid" value="<?= htmlspecialchars($petid) ?>">
    <input type="hidden" name="currentStatus" value="<?= htmlspecialchars($petDetails['applicationStatus'] ?? 'N/A') ?>">
    <button type="submit" class="btn btn-danger btn-sm mb-4">REJECTED</button>
</form>
