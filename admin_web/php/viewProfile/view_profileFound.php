        ...
        <div class="card shadow-lg p-4">
          ...
          <div class="row g-4">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group my-2">
                <label for="description"><strong>Found By/ Returned By:</strong></label>
                <input
                    type="text"
                    id="foundBy"
                    class="form-control"
                    value="<?= htmlspecialchars($petDetails['foundBy'] ?? 'N/A') ?>"
                    disabled
                  />
              </div>
              <div class="form-group my-2">
                <label for="description"><strong>Found At/ Returned At:</strong></label>
                <input
                    type="text"
                    id="foundAt"
                    class="form-control"
                    value="<?= htmlspecialchars($petDetails['foundAt'] ?? 'N/A') ?>"
                    disabled
                  />
              </div>
              <div class="form-group my-2">
                <label for="description"><strong>Found On/ Returned At:</strong></label>
                <input
                    type="text"
                    id="foundOn"
                    class="form-control"
