...
if (isset($_GET['petid']) && isset($_GET['collection'])) {
    ...
    $currentDocument = $firebase->getDocument("wandering", $petid);
    ...
    $updateResponse = $firebase->updateDocument("wandering", $petid, $updateData);
    ...
    header("Location: view_profileWandering.php?petid=" . urlencode($petid));
    exit();
}
?>
