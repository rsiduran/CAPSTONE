...
if ($userEmail) {
    ...
    foreach ($allPets as $pet) {
        ...
        if (isset($pet['email']) && $pet['email'] === $userEmail && $pet['applicationStatus'] === 'COMPLETED')  {
            $pets[] = $pet;
        }
    }
}
...
<body>
  ...
  <div class="main-content">
    <div class="container-fluid mt-5 pt-3">
      <h1>Adopted Pets </h1>
      <p>Below is the list of pets adopted by user which currently registered in the system:</p>
          ...
          <?php if (!empty($pets)) : ?>
            <?php foreach ($pets as $pet) : ?>
              <tr>
                ...
                <td>
                  <a href="view_profileUserAdopt.php?email=<?php echo $pet['email']; ?>" class="btn btn-primary btn-sm">View Profile</a>
                </td>
            </tr>
            <?php endforeach; ?>
          <?php else : ?>
            <tr>
              <td colspan="5" class="text-center">No adopted pets found</td>
            </tr>
          <?php endif; ?>
          </tbody>
        </table>
