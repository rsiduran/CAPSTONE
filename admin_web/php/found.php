...
<head>
  ...
  <title>Found Pet - Wanderpets</title>
...
<body>
  ...
  <form method="GET" class="mb-4">
      <div class="input-group" style="width: 50%; margin: 0 auto;">
          ...
          <a href="found.php" class="btn btn-secondary">Reset</a>
      </div>
    </form>
          ...
          <?php if (!empty($pets)) : ?>
            <?php foreach ($pets as $petid => $pet) : ?>
              ...
              ?>
                ...
                <td>
                <a href="viewProfile/markAsViewedFound.php?petid=<?= urlencode($petid) ?>&collection=found" class="btn btn-primary btn-sm">View Profile</a>
                  <a href="found.php?petid=<?= urlencode($petid) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this pet?');">Delete</a>
                </td>
              </tr>
            <?php endforeach; ?>
          <?php else : ?>
